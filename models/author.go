...
type Author struct {
	...
	Books types.JSON `boil:"books" json:"books" toml:"books" yaml:"books"`
...
var AuthorWhere = struct {
	ID    whereHelperint
	Books whereHelpertypes_JSON
}{
	ID:    whereHelperint{field: "\"author\".\"id\""},
	Books: whereHelpertypes_JSON{field: "\"author\".\"books\""},
}
...
var (
	authorAllColumns            = []string{"id", "books"}
	authorColumnsWithoutDefault = []string{}
	authorColumnsWithDefault    = []string{"id", "books"}
